...
\begin{lstlisting}[caption=Steps]{Name}
{
    "date": 1582945200000,
    "lat": 35.535751,
    "lon": 139.629355,
...
\end{minipage}\hfill
\begin{minipage}[b]{.24\textwidth}
\begin{lstlisting}[caption=Activities]{Name}
{
    "type": 0,
    "start": 1582941600000,
    "end": 1582945200000,
...
\end{minipage}\hfill
\begin{minipage}[b]{.24\textwidth}
\begin{lstlisting}[caption=Location]{Name}
{
    "date": 1582945200000,
    "accuracy": 0,
    "anonymity": 2,
...
\end{minipage}\hfill
\begin{minipage}[b]{.24\textwidth}
\begin{lstlisting}[caption=Presence]{Name}
{
    "start": 1582941600000,
    "end": 1582945200000,
    "lat": 35.535751,
...
\end{lstlisting}
\end{minipage}
\caption{Search options for requests}
\label{fig:search_options}
\end{figure}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/modules.png}

...
%This enables adversaries to deduce identity information using other publicly available data sets or auxiliary knowledge. 
...
% Todo: Not used because focus in actual location data and dif not suitable but useful for presence
% Todo: Doesn't work if queried again
...
Casper
% Todo: \cite[The New Casper: Query Processing for Location Serviceswithout Compromising Privacy]
...
% Todo: Casper and Interval Cloak and Hilbert Cloak
